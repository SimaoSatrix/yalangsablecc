...
public final class AChamadaFuncaoChamada extends PChamada
{
    private TVariavel _variavel_;

    public AChamadaFuncaoChamada()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AChamadaFuncaoChamada(
    ...
    {
        ((Analysis) sw).caseAChamadaFuncaoChamada(this);
    }
